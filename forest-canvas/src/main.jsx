...
const router = createBrowserRouter([
  {
    ...
    children:[
      ...
      },
      {
        ...
        loader: ()=> fetch("https://forest-canvas-server-3h55by99a-wasim-hossains-projects.vercel.app")
      },
      {
      ...
      },
      {
        ...
        loader: ({params})=> fetch(`https://forest-canvas-server-3h55by99a-wasim-hossains-projects.vercel.app/${params.id}`)
      },
      {
        path: '/login',
        element: <Login></Login>
