    ...
    return (
        <>
            ...
            <div className="container mx-auto mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-3 border-2 rounded-lg">
                    <section data-aos="zoom-out" data-aos-duration="1000"  data-aos-delay="500" className="grid md:grid-cols-2 gap-2 p-4">
                        ...
                        <div className="lg:h-40 h-[100vh] w-full relative lg:max-w-xs overflow-hidden bg-cover bg-no-repeat rounded-lg">
                            <img className="h-full w-full rounded-lg  transition duration-300 ease-in-out hover:scale-110"  src="https://i.ibb.co/B2PYcCd/img6.jpg"/>
                        </div>
                        <div className="md:h-40 relative  overflow-hidden bg-cover bg-no-repeat rounded-lg">
                            <img className="h-full w-full rounded-lg  transition duration-300 ease-in-out hover:scale-110"  src="https://i.ibb.co/H2wR2tb/img5.jpg"/>
                        </div>
                    </section>
                    ...
                    <div className="lg:h-80 flex p-3 relative overflow-hidden bg-cover bg-no-repeat rounded-lg">
                        <img className="h-full rounded-lg w-full transition duration-300 ease-in-out hover:scale-90" src="https://i.ibb.co/hC5rf01/The-Forest-Queen.jpg"/>
                    </div>
                    </section>
                </div>
            </div>
